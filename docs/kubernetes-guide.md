# Kubernetes Beginner's Guidebook

> A personal Kubernetes cluster running real apps — documented from zero to advanced.
>
> 💡 This document works as a **Kubernetes beginner's guidebook**.
...
- [4. 🔬 Understand in 100 minutes](#4--understand-in-100-minutes)
  ...
  - [4.8 GitOps — what it means and why it matters](#48-gitops--what-it-means-and-why-it-matters)
    ...
    - [4.8.2 How this repo relates to GitOps](#482-how-this-repo-relates-to-gitops) ➡️ [Full ArgoCD Guide](argocd-guide.md)
...
> 📖 **New to ArgoCD?** Read the full beginner's guide: **[ArgoCD Guide — From Zero to GitOps](argocd-guide.md)**
>
...
> _You know: GitOps means Git is the source of truth. ArgoCD watches this repo and auto-applies changes to the cluster. See the [full ArgoCD guide](argocd-guide.md) for hands-on instructions._
